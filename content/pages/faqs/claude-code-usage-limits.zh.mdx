...
Claude Code 官方 legal 材料把普通订阅使用和开发者/产品使用区分开。OAuth 登录用于 Free、Pro、Max、Team、Enterprise 等订阅访问；如果开发者要构建使用 Claude 能力的产品或服务，应通过 Console 或受支持云厂商使用 API key 认证。

自动化、headless、SDK 或产品化工作流不要默认套用订阅限制。规划前应重新核查当前 legal、pricing 和 billing 文档。
