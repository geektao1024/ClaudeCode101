---
title: 'Claude Code Global Prompts: User Rules and Defaults'
description: 'Set Claude Code global prompts and user rules to shape default behavior, reduce repeated instructions, and keep coding sessions consistent.'
---
