...
## High-Intent MCP Searches

Use these common Claude Code MCP searches as routing signals, not as reasons to install every server:

| Search term                  | Best destination                                    | What the user usually needs                                                                  |
| ---------------------------- | --------------------------------------------------- | -------------------------------------------------------------------------------------------- |
...
When the query includes a specific server name, answer the workflow first: what it should read, whether it can write, which credentials it needs, and how to verify with `claude mcp list`, `claude mcp get <server-name>`, and `/mcp`.
