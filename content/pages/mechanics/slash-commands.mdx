...
description: 'A practical Claude Code slash commands guide covering built-in commands, custom commands, skills, arguments, frontmatter, dynamic context, MCP prompts, and team workflow design.'
---
