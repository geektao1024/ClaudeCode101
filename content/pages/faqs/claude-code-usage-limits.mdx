...
description: 'Claude Code usage limits explained: subscription vs API metering, session and weekly limits, context length, /usage, /cost, /clear, /compact, extra usage, and cost-control habits.'
