---
title: 'Claude Code API Documentation: API Reference, Agent SDK, CLI, and MCP'
description: 'Find the right official Claude Code API documentation: Anthropic Messages API, Claude Code CLI, Agent SDK, MCP servers, headless mode, authentication, and automation examples.'
---
...
<Callout type="info">
  Last checked on May 24, 2026. ClaudeCode101 is an independent tutorial site,
  ...
  authentication in Anthropic or Claude Code docs before shipping production code.
</Callout>
...
3. Add [CLAUDE.md](/en/tutorial/configuration/claude-md) so Claude understands project rules.
