...
| "claude code sessions"                | Resume, compact, clear, branch, and naming guide               |
| "statusline claude code"              | Terminal state, model, context, cost, and branch guide         |
| "claude code remote control"          | Local execution plus remote steering guide                     |
