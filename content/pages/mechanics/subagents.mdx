...
description: 'A practical guide to Claude Code subagents: when to use them, how to create custom agents, tool permissions, context isolation, background tasks, memory, hooks, and team rollout.'
---
