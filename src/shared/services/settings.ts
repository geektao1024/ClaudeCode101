...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'ClaudeCode101 is a practical Claude Code tutorial and workflow knowledge base.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'ClaudeCode101 <no-reply@mail.claudecode101.com>',
      group: 'resend',
      tab: 'email',
    },
    {
