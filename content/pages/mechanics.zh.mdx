...
description: 'Claude Code 核心机制入口：CLAUDE.md、Plan Mode、上下文管理、Slash Commands、Hooks、Subagents、权限和团队工作流。'
---
...
- **高级工作流路径：** [上下文管理](/zh/mechanics/context-management) -> [Subagents](/zh/mechanics/subagents) -> [MCP 安全清单](/zh/mcp/mcp-security-checklist)
