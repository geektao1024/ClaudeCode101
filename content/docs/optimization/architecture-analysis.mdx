---
title: 'Claude Code Architecture Analysis for Existing Projects'
description: 'Use Claude Code to map project structure, dependencies, boundaries, and risks before refactoring or adding major features.'
---
