---
title: 'Claude Code Code Quality: Reviews, Refactors, and Tests'
description: 'Use Claude Code to review code quality, spot maintainability risks, plan refactors, add tests, and avoid low-value AI changes.'
---
