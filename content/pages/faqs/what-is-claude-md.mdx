---
title: 'What Is CLAUDE.md? Claude Code Memory and Rules'
description: 'CLAUDE.md explained for Claude Code: official memory docs, project file location, CLAUDE.local.md, .claude/rules, imports, AGENTS.md, and team setup.'
...
> Last checked on July 7, 2026. Claude Code memory behavior can evolve, so treat this page as a practical guide and verify unusual setups against the official [Claude Code memory docs](https://code.claude.com/docs/en/memory).

## Short Answer

Create `CLAUDE.md` when Claude Code needs durable project context. Put the shared version where the team can find it, keep it short enough to stay useful, and update it only when a rule is stable. If you are looking for the official documentation, start with Claude Code memory docs, then use this page for examples and setup choices.
