---
title: 'Claude Code Git Workflow: Commits, Branches, and PRs'
description: 'Use Git with Claude Code for safe commits, branches, diffs, PR preparation, rollback points, and reviewable coding sessions.'
---
