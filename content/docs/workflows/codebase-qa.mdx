---
title: 'Claude Code Codebase Q&A: Understand Large Projects'
description: 'Ask Claude Code architecture, dependency, flow, and file questions to understand unfamiliar repositories before changing code.'
---
